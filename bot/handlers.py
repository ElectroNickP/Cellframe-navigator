...
def register_handlers(dp: Router) -> None:
    ...
    async def cmd_faq(message: types.Message) -> None:
        ...
        faq_text = (
            ...
            "<b>Q: Why can't the bot find my transaction?</b>\n"
            "A: Possible reasons:\n"
            "• TX is very fresh (wait 1-2 minutes)\n"
            "• Wrong network (check in explorer)\n"
            "• Typo in hash (copy from wallet)\n\n"
            
            "<b>Q: How long to wait for confirmation?</b>\n"
            "A: Depends on network:\n"
            "• Ethereum: ~3 minutes (12 blocks)\n"
            "• BSC: ~45 seconds (15 blocks)\n"
            "• Cellframe: ~30 seconds (3 blocks)\n\n"
            
            "<b>Q: How to know when TX is confirmed?</b>\n"
            "A: Bot will notify you automatically!\n"
            "• Progress updates every 30 seconds\n"
            "• Final notification when confirmed\n\n"
            
            "<b>Q: Can I track multiple TXs?</b>\n"
            "A: Yes! Use:\n"
            "• /track for each new TX\n"
            "• /mysessions to see all\n"
            "• /stats for statistics\n\n"
            
            "<b>Q: TX already confirmed, why track?</b>\n"
            "A: You can check status:\n"
            "• Number of confirmations\n"
            "• Block number\n"
            "• Explorer link\n\n"
            
            "<b>Q: What does \"TX not found\" mean?</b>\n"
            "A: TX not found on any network.\n"
            "Try:\n"
            "• Wait 1-2 minutes and retry\n"
            "• Check hash in block explorer\n"
            "• Make sure TX is confirmed\n\n"
            
            "<b>Q: Bot responds slowly</b>\n"
            "A: Possible reasons:\n"
            "• RPC node overloaded (retry)\n"
            "• Network issues (check internet)\n"
            "• Usually responds in 2-5 seconds\n\n"
            
            "❓ <b>Can't find answer?</b>\n"
            "Send /help for command list\n"
            "or check <a href='https://docs.cellframe.net'>documentation</a>"
        )
    ...
    async def cmd_stats(message: types.Message) -> None:
        ...
        async with SessionFactory() as db_session:
            ...
            stats_text = (
                ...
                f"• Completed: {completed_sessions} ✅\n"
                f"• Success Rate: {success_rate:.1f}%\n\n"
                
                f"<b>📦 Transactions:</b>\n"
                f"• Tracking: {user_pending} ⏳\n\n"
                
                f"<b>🔥 Quick Commands:</b>\n"
                f"/mysessions - View all sessions\n"
                f"/track - Track new TX\n"
                f"/faq - Frequently asked questions\n\n"
                
                f"<i>Thank you for using Cellframe Bridge! 🚀</i>"
            )
        ...
        try:
            ...
            if not detected_chain or not tx_info:
                await message.answer(
                    ...
                    "<b>💡 What to do?</b>\n"
                    "• Check TX hash (copy again from wallet)\n"
                    "• Wait 1-2 minutes and try again\n"
                    "• Make sure TX is confirmed on network\n"
                    "• Check TX in block explorer:\n"
                    "  - <a href='https://etherscan.io'>Etherscan</a> (Ethereum)\n"
                    "  - <a href='https://bscscan.com'>BscScan</a> (BSC)\n"
                    "  - <a href='https://cfscan.io'>CFScan</a> (Cellframe)\n\n"
                    "❓ If problem persists - /faq"
                )
                return
            ...
            await message.answer(
                ...
                "• Check TX in block explorer\n"
                "• Send /faq for help\n\n"
                f"<i>Technical error: {str(e)[:100]}</i>"
            )
